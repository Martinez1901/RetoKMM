...
class ComicViewModel: ViewModel() {
    ...
    fun listComics(): List<Character> {
        return listOf(
            ...
            Character(5, "Hulk", thumbnailPath = "http://i.annihil.us/u/prod/marvel/i/mg/4/20/4bc697c680890"),
            Character(6, "Capitan America", thumbnailPath = "http://i.annihil.us/u/prod/marvel/i/mg/f/20/4bc63a47b8dcb"),
        )
    }
}